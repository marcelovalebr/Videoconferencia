...
<body>
    ...
    <div class="message-container">
        ...
        $sql = "INSERT INTO videoconferencias (vc, diex, solicitante, data, local, horario, link, informacoes) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssssssss", $videoconferencia, $diex, $solicitante, $data, $local, $horario, $link, $informacoes);
