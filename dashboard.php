    ...
    <section class="dashboard-container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<p>DIEx: " . $row['diex'] . "</p>";
                echo "<p>Solicitante: " . $row['solicitante'] . "</p>";
                echo "<p>Data: " . date('d/m/Y', strtotime($row['data'])) . "</p>";
                ...
                if (!empty($row['link'])) {
                    ...
                    echo "<p>Link:<br><br><a href='{$link}' target='_blank'>{$link}</a></p>";
                }

                echo "<p>Informações adicionais: " . $row['informacoes'] . "</p>";
